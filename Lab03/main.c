...
void correct_cmd(){
    ...
    // if (sscanf(correct_cmd, " putty%s", correct_cmd_temp) == 1) {
    //     strcpy(correct_cmd, correct_cmd_temp);
    //     flag=1;
    // }else if (sscanf(correct_cmd, " xterm-256%s", correct_cmd_temp) == 1) {
    //     strcpy(correct_cmd, correct_cmd_temp);
    //     flag=1;
    // }

    // if(flag){
    // if (sscanf(correct_cmd, "color%s", correct_cmd_temp) == 1) {
    //     strcpy(correct_cmd, correct_cmd_temp);
    // }else if (sscanf(correct_cmd, "blink%s", correct_cmd_temp) == 1) {
    //     strcpy(correct_cmd, correct_cmd_temp);
    // }}
